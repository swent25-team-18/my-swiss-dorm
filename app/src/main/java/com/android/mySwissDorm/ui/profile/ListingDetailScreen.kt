...
import com.android.mySwissDorm.ui.profile.FieldBlock
...
/** Bloc plein largeur qui imite un champ de formulaire en lecture seule :
 *  fond clair, coin arrondi, fine bordure, label gris + valeur. */
@Composable
